...
export const dashboardEnUS = {
  ...
  shell: {
    ...
    navigation: {
      ...
      workbuddy: {
        label: 'WorkBuddy',
        description: 'View WorkBuddy project JSONL requests, models, and token/credit trends',
      },
      privacy: {
  ...
  calls: {
    ...
    table: {
      ...
      replacementFailed: 'Unable to read results for the current filters and sort. Try again.',
  ...
  sources: {
    page: {
      ...
      updateErrorBody: 'The data-root update failed. Original {{client}} files were not modified.',
      scanErrorTitle: 'Unable to run the scan',
      scanErrorBody: 'The scan operation failed. Original {{client}} files were not modified.',
    },
    background: {
      runningTitle: 'Background Token statistics running',
      runningBody: 'Updating local {{client}} usage. The page refreshes automatically when done.',
    ...
    discovery: {
      ...
      failedBody: 'Stable error code: {{code}}. Fix the environment and start discovery again.',
      strategy: {
      ...
      platform: {
        other: 'This platform uses data source discovery across confirmed local directories.',
      },
      scope: {
  ...
  backend: {
    message: {
      overviewLocalIndexUnavailable: 'The local index is temporarily unavailable. Try again.',
      ...
      sourceRegistered: 'The data directory was registered. Run a quick scan to build its index.',
      ...
      sourceEnabled: 'The data directory is enabled and will be included in the next quick scan.',
      sourceDisabled:
      ...
      indexCleared: 'This app’s index was cleared. Original client files were not modified.',
    },
    display: {
    ...
    indexLocation: {
      ...
      grokBuildCli: 'This app’s data directory / clients / grok-build-cli / usage-index.sqlite3',
    },
  },
  updater: {
  ...
  sponsor: {
    ...
    payment_instructions: 'After payment, add QQ 2222980 with screenshot proof to join the group.',
    sponsor_message:
  ...
  about: {
    ...
    release_notes_unavailable: 'This development build does not include formal release notes yet.',
