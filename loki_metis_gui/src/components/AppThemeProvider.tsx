...
export const APP_THEME_VARIABLES: CSSVariablesResolver = (theme) => ({
  ...
  light: {
    ...
    "--app-violet-border": theme.colors.indigo[3],
    ...
    "--app-image-hover-border": theme.colors.indigo[3],
  },
  dark: {
    ...
    "--app-violet-border": theme.colors.indigo[8],
    "--app-control-background": "#1b1d24",
    "--app-control-hover-border": theme.colors.indigo[6],
    ...
    "--app-image-hover-border": theme.colors.indigo[6],
  },
});
