...
import { invalidateLocalUsageQueries, SCAN_STATUS_POLL_INTERVAL_MS } from '../api/usage-queries';
...
export function LocalScanProgressBar({ enabledAgents }: { enabledAgents: AgentClientKind[] }) {
