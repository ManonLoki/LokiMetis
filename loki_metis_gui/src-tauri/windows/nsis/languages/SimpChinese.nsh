; LokiMetis 简体中文 NSIS 文案：基于 @tauri-apps/cli 2.11.4 的同名语言文件。
LangString productDisplayName ${LANG_SIMPCHINESE} "诡秘神谕"
LangString addOrReinstall ${LANG_SIMPCHINESE} "添加/重新安装组件"
LangString alreadyInstalled ${LANG_SIMPCHINESE} "已安装"
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "诡秘神谕 ${VERSION} 已经安装了。选择你想要执行的操作后点击下一步以继续。"
LangString appRunning ${LANG_SIMPCHINESE} "诡秘神谕 正在运行！请关闭后再试。"
LangString appRunningOkKill ${LANG_SIMPCHINESE} "诡秘神谕 正在运行！$\n点击确定以终止运行。"
LangString chooseMaintenanceOption ${LANG_SIMPCHINESE} "选择要执行的维护操作。"
LangString choowHowToInstall ${LANG_SIMPCHINESE} "选择你想要安装 诡秘神谕 的方式。"
...
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法终止 诡秘神谕。请关闭后再试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "有一个更新版本的 诡秘神谕 已经安装了！不推荐你安装旧的版本。如果你真的想要安装这个旧的版本，推荐先卸载当前版本。选择你想要执行的操作后点击下一步以继续。"
LangString older ${LANG_SIMPCHINESE} "旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统中已存在版本为 $R4 的 诡秘神谕。推荐先卸载当前版本后再进行安装。选择你想要执行的操作后点击下一步以继续。"
...
LangString uninstallApp ${LANG_SIMPCHINESE} "卸载 诡秘神谕"
