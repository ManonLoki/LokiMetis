...
pub use agent_hooks::{
    ...
    hook_relay_loopback_address, hook_supports_wsl, managed_hook_marker, merge_hook_config,
    normalize_enabled_ai_tools, prepare_native_hook, remove_managed_hook_entries, tool_from_slug,
};
pub use aggregate::{
...
pub use policy::{
    DiscoveryBatchIndexDecision, DiscoveryBatchKind, LOCAL_DISCOVERY_WORKER_LIMIT,
    LOCAL_INDEX_WORKER_LIMIT, LocalIndexScanPolicy, LocalIndexScanWindow, ManualSourceAddDecision,
    ManualSourceInspectOutcome, PeriodicQuickScanError, PeriodicScanTick,
    PrimarySourceRootSupportError, ScanKind, ScanStartAccessError, ScanStartOrigin,
    ...
    local_index_scan_policy_with_retention, merge_coverage_reports, normalize_source_root_alias,
    retain_ingestable_calls, safe_model_label, safe_root_label, safe_short_value,
...
pub use settings::{
    CURRENT_INITIALIZATION_WIZARD_KEY, DEFAULT_RETENTION_DAYS, DEFAULT_SCAN_INTERVAL_MINUTES,
    DEFAULT_WORKBUDDY_STATS_ENABLED, EnabledAgents, EnabledAgentsError, MAX_RETENTION_DAYS,
    ...
    parse_single_agent_label, privacy_settings_save_failed_message, resolve_retention_days,
